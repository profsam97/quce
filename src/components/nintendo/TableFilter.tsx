  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-between py-4 px-6">
        <div className="flex items-center">
          <div className="flex mr-8">
            <div className="bg-gray-100 rounded-l-md overflow-hidden">
              <Button 
                variant="ghost" 
            ...
            <div className="bg-gray-100 rounded-r-md overflow-hidden">
              <Button 
                variant="ghost" 
                className={`rounded-none px-6 py-2 h-auto ${
                  activeTab === "request" 
      ...
      <div className="flex items-center justify-between py-4 px-6 border-t border-b border-gray-200">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" className="bg-[#FAF1F1] border-gray-200 text-[#B81C1D] hover:bg-gray-50">
            <RefreshCw className="mr-2 h-4 w-4" />
            Refresh Table
          </Button>
          <Button variant="outline" className="bg-[#FAF1F1] border-gray-200 text-[#B81C1D] hover:bg-gray-50 gap-1">
